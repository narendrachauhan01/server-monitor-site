            ...
            <form onSubmit={handleUserLogin} className="login-right-form">
              ...
              {forgotIsGoogle && (
                <div className="login-google-hint">
                  ...
                  <button type="button" className="login-submit" style={{marginTop:8}} onClick={() => { setShowForgot(false); setForgotIsGoogle(false); handleGoogleClick(); }}>
              ...
              <div ref={googleBtnRef} style={{display:'none', marginTop:8}} />
            </form>
          )}
